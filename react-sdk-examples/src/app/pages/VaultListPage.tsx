...
import { useVerifiedVaults } from "../queries/sdkQueries";
import {
...
import { formatBigInt, formatAPY, formatPriceUsd } from "../utils/format";
              ...
              <tbody>
                {eVaults.map((vault) => (
                  <tr
                    ...
                    className="clickable"
                    onClick={() =>
                      router.push(`/vault/${chainId}/${vault.address}`)
                    }
                  >
              ...
              <tbody>
                {earnVaults.map((vault) => (
                  <tr
                    ...
                    className="clickable"
                    onClick={() =>
                      router.push(`/earn/${chainId}/${vault.address}`)
                    }
                  >
                    <td>{vault.shares.name || "-"}</td>
                    <td>{vault.asset.symbol}</td>
