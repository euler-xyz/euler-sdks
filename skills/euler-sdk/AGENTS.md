...
- `oracleAdapterService` for Data V3 oracle adapter recognition and health assessments plus indexed router state; assessment maps use normalized adapter addresses
...
- minutes: oracle assessment lookups such as `queryV3OracleAdapterAssessment` and `queryV3OracleAdapterAssessmentsPage`
