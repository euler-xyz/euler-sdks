...
### How to use skills
- Trigger rule: If user asks for SDK integration help or names `euler-sdk`, load and follow `/Users/dariusz/Euler/euler-sdks/packages/euler-v2-sdk/skills/euler-sdk/SKILL.md`.
