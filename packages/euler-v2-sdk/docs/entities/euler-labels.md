...
| `tags` | `string[] | undefined` | Freeform classification tags (e.g. `"keyring"`, `"access control"`, `"governance limited"`). |
...
| `tags` | `string[] | undefined` | Freeform classification tags overriding/augmenting product tags (e.g. `"keyring"`, `"access control"`, `"recently added"`). |
