...
async function liquidationExample() {
  ...
  violatorAccountData.subAccounts = [
    await sdk.accountService.fetchSubAccount(mainnet.id, VIOLATOR_SUB_ACCOUNT_ADDRESS, [
      EULER_PRIME_USDC_VAULT,
      EULER_PRIME_USDT_VAULT,
    ]),
  ];
  ...
  liquidatorAccountData.subAccounts = [
    await sdk.accountService.fetchSubAccount(mainnet.id, LIQUIDATOR_SUB_ACCOUNT_ADDRESS, [
      EULER_PRIME_USDC_VAULT,
      EULER_PRIME_USDT_VAULT,
    ]),
  ];
