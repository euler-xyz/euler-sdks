...
ANVIL_EXAMPLES=(
  ...
  "execution/multiply-same-asset-example.ts"
  "execution/multiply-from-savings-example.ts"
  "execution/same-asset-position-migration-example.ts"
  "execution/morpho-to-euler-position-migration-example.ts"
  "execution/euler-to-morpho-position-migration-example.ts"
  "execution/aave-to-euler-position-migration-example.ts"
  "execution/euler-to-aave-position-migration-example.ts"
  ...
  "execution/swap-and-borrow-from-wallet-example.ts"
  "execution/swap-and-repay-from-wallet-example.ts"
  "execution/withdraw-and-swap-example.ts"
  "execution/redeem-and-swap-example.ts"
