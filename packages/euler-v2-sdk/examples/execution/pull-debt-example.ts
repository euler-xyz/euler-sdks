 ...
 *   3. Run: npx tsx execution/pull-debt-example.ts
...
async function pullDebtExample({ walletClient }: Awaited<ReturnType<typeof initExample>>) {
  // Build the SDK
...
initExample().then(pullDebtExample).catch((error) => {
