	...
	implements ISecuritizeCollateralAdapter
{
	...
	setQuerySecuritizeVaultGovernorAdmin(
		fn: typeof this.querySecuritizeVaultGovernorAdmin,
	): void {
	...
	setQuerySecuritizeVaultSupplyCapResolved(
		fn: typeof this.querySecuritizeVaultSupplyCapResolved,
	): void {
